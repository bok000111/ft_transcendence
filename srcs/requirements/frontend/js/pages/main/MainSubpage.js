                ...
                <div class="row justify-content-center mt-5">
                    <div class="col-md-6 col-lg-4">
                        <div class="row mb-4 pt-4 pb-3">
                            <div class="col">
                                <button id="aiGame" class="btn btn-warning btn-lg btn-block">AI MODE</button>
                            </div>
                        </div>
                        <div class="row mb-4 pt-4 pb-3">
                            <div class="col">
                        ...
                        <div class="row mb-4 pt-4 pb-3">
                            <div class="col">
                                <button id="normalGame-2" class="btn btn-warning btn-lg btn-block">NORMAL MODE - 2</button>
                            </div>
                        </div>
                        <div class="row mb-4 pt-4 pb-3">
                            <div class="col">
                                <button id="normalGame-4" class="btn btn-warning btn-lg btn-block">NORMAL MODE - 4</button>
                            </div>
                        </div>
                        <div class="row mb-4 pt-4 pb-3">
                            <div class="col">
                                <button id="tourGame" class="btn btn-warning btn-lg btn-block">TOURNAMENT MODE</button>
                            </div>
                        </div>
                        <div class="row mb-4 pt-4 pb-3">
                            <div class="col">
