...
echo run 'source ./backend/.venv/bin/activate' to activate the virtual environment
echo run 'deactivate' to deactivate the virtual environment
echo run 'pip3 freeze > requirements.txt' to update the requirements.txt file
